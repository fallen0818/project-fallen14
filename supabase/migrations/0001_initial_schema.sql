...
-- =============================================================================
-- This is the original supabase/schema.sql content, promoted to migration
-- 0001 so supabase/migrations/ is a complete, self-sufficient history for a
-- fresh `supabase db push` -- previously this content only existed as a
-- standalone snapshot file, with no numbered migration creating the base
-- 24 tables (0002 onward all assume this already ran). See
-- supabase/SCHEMA_RESTRUCTURE.md for why schema.sql was retired.
-- =============================================================================
