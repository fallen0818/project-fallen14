-- =============================================================================
-- Migration 0006 — normalize vendor identity into a dedicated `vendors` table
-- =============================================================================
...
--   select id, code from public.vendor_biddings
--     where status = 'awarded' and awarded_vendor_id is null;
--     -- (an RFQ with no award yet, e.g. status 'under-evaluation', is
--     -- expected to have a null awarded_vendor_id — only flag ones already
--     -- marked 'awarded' with nothing filled in)
--
