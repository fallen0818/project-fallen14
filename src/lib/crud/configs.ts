...
export const ENTITIES: EntityConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "description", label: "Description", type: "textarea" },
      { name: "asset_category", label: "Category", type: "select", options: CATEGORY, required: true },
      ...
      { name: "priority", label: "Priority", type: "select", options: ["low", "medium", "high", "critical"], inList: true, badge: true },
      ...
      { name: "status", label: "Status", type: "select", options: ["draft", "submitted", "under-review", "approved", "rejected", "cancelled", "procured"], required: true, inList: true, badge: true },
    ],
  },
  ...
  // =========================================================================
  {
    ...
    fields: [
      ...
      { name: "category", label: "Category", type: "select", options: ["goods", "services", "works", "software-license", "subscription"], required: true, inList: true },
      ...
      { name: "preferred_vendor_id", label: "Preferred Vendor", type: "text" },
      { name: "status", label: "Status", type: "select", options: ["identified", "requisitioned", "sourcing", "ordered", "received", "cancelled"], required: true, inList: true, badge: true },
    ],
  },
  {
    key: "requisitions",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "status", label: "Status", type: "select", options: ["open", "closed", "under-evaluation", "awarded", "cancelled"], required: true, inList: true, badge: true },
      { name: "awarded_vendor_id", label: "Awarded Vendor", type: "text" },
    ],
  },
  {
    key: "purchase-orders",
    ...
    fields: [
      ...
      { name: "vendor_id", label: "Vendor ID", type: "text", required: true, inList: true },
      { name: "vendor_name", label: "Vendor Name", type: "text", inList: true },
      ...
      { name: "status", label: "Status", type: "select", options: ["issued", "acknowledged", "partially-received", "received", "invoiced", "paid", "closed", "cancelled"], required: true, inList: true, badge: true },
    ],
  },
